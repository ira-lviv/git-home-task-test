...
namespace MarsRoverKata
{
    public class Rover
    {
        ...
        public Rover()
        {
            mars = new Mars(new Size(25, 25));
            LandOnMars(mars.CenterOfThePlanet);
        }
        ...
        //    if (!mars.IsValidPosition(newDestination))
        //    {
        //        return from;
        //    }
        ...
        //{
        //    bool anyInstance = mars._obstacles.Any(x => x.Location.Equals(point));
